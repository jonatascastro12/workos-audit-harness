/**
 * Claude Code WorkOS audit schema definitions.
 *
 * WorkOS schema creation expects a compact form where metadata property values
 * are primitive type names. The Node SDK expands these into JSON Schema.
 */
...
export function getClaudeAuditSchemaDefinitions(prefix = 'claude') {
  return [
    {
